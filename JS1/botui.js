...
function bot_ui_ini() {
    ...
    secondpart = function() {
        botui.message.add({
            delay: 1500,
            content: "就读于湖南应用技术学院，即将步入大二。"
        }).then(function() {
            botui.message.add({
                delay: 1500,
                content: "是在计算机专业学计算机应用未来程序猿"
            }).then(function() {
                botui.message.add({
                    delay: 1200,
                    content: "将敲代码看成一种快乐"
                    ...
                    botui.message.add({
                        delay: 1500,
                        content: "主修 Java后端 ,略知 linux,偶尔也搞 HTML/CSS/JavaScript/Spring"
                    }).then(function() {
                        botui.message.add({
                            delay: 1500,
                            content: "专业方向，java后端开发"
                        }).then(function() {
                            botui.message.add({
                                delay: 1800,
                                content: "喜欢刷番和玩手游"
    ...
    fourthpart = function() {
        botui.message.add({
            delay: 1e3,
            content: "我的游戏名叫OY,后来也有人叫我欧阳，所以就有了OY这个了"
        }).then(function() {
            botui.message.add({
                delay: 1100,
    ...
    fifthpart = function() {
        botui.message.add({
            ...
            botui.message.add({
                delay: 1600,
                content: "那么，很高心认识你，相遇就是缘分，留下你的足迹吧 ^_^"
            })
        })
    }
}